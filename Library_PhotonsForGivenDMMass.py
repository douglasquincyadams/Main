...
def Main(DMMass=None,
    ...
    #import the photons
    FermiEventLocations3D,EventEnergiesSelected,EnergyMaxOut,EnergyMinOut=DS_LoadPhotonsForEnergyRange.Main(EnergyMax=DMMass*1.3,EnergyMin=DMMass/1.3)
    print 'photons done'
    ...
    return EventEnergiesSelected[setofphtons],GroupSourcesData,GroupSourcesDataColumnNames,FinalHaloIndex,EnergyMaxOut,EnergyMinOut  
