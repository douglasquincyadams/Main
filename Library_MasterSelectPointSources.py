...
def Main(DMMass=None,
    ...
    PS_Spline=Library_PSF.Main(DMMass=DMMass,ConfidenceLevel=config.PointSourceConfidenceLevel)
    PSF=PS_Spline(0.)
    #print PSF
    ...
    IndexAboveCuttoff=Library_SelectPointSources.Main(PointSources=PointSourcesData,
                                    DMMass=DMMass,
                                    MaxEnergy=MaxEnergy,
                                    MinEnergy=MinEnergy,
                                    )
    
    return SurfProjPointSourceLoc3D,SurfProjPointSourceLocRadii,PointSourcesData,IndexAboveCuttoff 
